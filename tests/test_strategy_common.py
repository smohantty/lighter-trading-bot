...
from src.strategy.common import calculate_grid_prices_by_spread, calculate_grid_prices, calculate_grid_spacing_pct
...
class TestStrategyCommon(unittest.TestCase):
    ...
    def test_calculate_grid_prices_by_spread_reverse_compatibility(self):
        ...
        geo_prices = calculate_grid_prices(
            GridType.GEOMETRIC, 
            lower, 
            real_upper, 
            n
        ...
        for p1, p2 in zip(spread_prices, geo_prices):
    ...
    def test_single_price_condition(self):
        ...
        self.assertEqual(len(prices), 0) # Should be empty as implementation returns empty if lower >= upper? 

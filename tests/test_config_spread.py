...
class TestConfigSpread(unittest.TestCase):
    ...
    def test_invalid_mixed_config(self):
        ...
        self.assertIn("spread_bips can only be used with GEOMETRIC grid type", str(cm.exception))
    ...
    def test_missing_params(self):
        ...
        self.assertIn("Either grid_count or spread_bips must be provided", str(cm.exception))

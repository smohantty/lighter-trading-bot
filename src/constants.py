...
RECONCILIATION_HEALTHY_SNAPSHOTS_TO_EXIT_DEGRADED = 1

# API Batch Processing (Lighter supports up to 50 tx per batch)
MAX_BATCH_SIZE = 49
DEGRADED_MODE_COOLDOWN_SECONDS = 30
COMPLETED_CLOID_CACHE_TTL_SECONDS = 24 * 60 * 60  # 24 hours
COMPLETED_CLOID_CACHE_MAX_SIZE = 100_000
OID_CLOID_CACHE_TTL_SECONDS = 24 * 60 * 60  # 24 hours
OID_CLOID_CACHE_MAX_SIZE = 200_000
UNRESOLVED_OID_FILL_ALERT_THRESHOLD = 3
